...
public class constants {
	...
	public static final String[] CONTINENT_COLOURS = {"Yellow","Blue","Green","Purple","Red","Orange"};  // for reference: colour of each continent on the map
	...
	public static final int[] CONTINENT_NUM_COUNTRIES = {9,7,12,4,4,6};
	public static final int FRAME_WIDTH = 1250;    // must be even
	public static final int FRAME_HEIGHT = 738;
	...
	//amount that players receive for exchanging cards
	public static final int[] CARD_REINFORCEMENTS = {4, 6, 8, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60}; 
	
	public static final int INFANTRY_NO = 1;
	public static final int CAVALRY_NO = 2;
	public static final int ARTILLERY_NO = 3;
	public static final int WILD_NO = 0;
	
	public static final String[] CARD_INSIGNIA_NAMES = {
			"Wild", "Infantry", "Cavalry", "Artillery"
	};
	
	//stores the insignia of each countries card
	public static final int[] CARD_INSIGNIAS = {
		2, 3, 3, 1, 2, 3, 1, 2, 1,           //North American Cards
		2, 1, 2, 3, 2, 1, 3,                 //Europe Cards
		1, 1, 3, 1, 2, 2, 2, 3, 1, 3, 3, 2,  //Asia Cards
		1, 2, 3, 2,                          //Australia Cards
		3, 2, 3, 1,                          //South America Cards
		2, 1, 3, 1, 3, 1,                    //Africa Cards
		0, 0                                 //Wild Cards
	};
